...
- (void)viewDidLoad 
{
	...
	UIColor *backgroundColor = [UIColor colorWithRed:0.174292 green:0.174292 blue:0.174292 alpha:1.0];
	UIColor *standardOutputTextColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:1.0];
